    ...
    class SportsViewModel : ViewModel() {
        ...
        fun updateHoursPlayed(sportId: Int, hours: Int) {
            val newMap = _uiState.value.hoursPlayed.toMutableMap()
            newMap[sportId] = hours
            _uiState.update { it.copy(hoursPlayed = newMap) }
        }

        fun totalCaloriesBurned(): Int {
            return _uiState.value.sportsList.sumOf { sport ->
                val hours = _uiState.value.hoursPlayed[sport.id] ?: 0
    ...
    data class SportsUiState(
        ...
        val hoursPlayed: Map<Int, Int> = emptyMap()
