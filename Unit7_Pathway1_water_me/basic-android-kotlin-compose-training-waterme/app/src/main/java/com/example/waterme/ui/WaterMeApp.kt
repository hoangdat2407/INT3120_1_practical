...
import com.example.waterme.THREE_MINS
import com.example.waterme.TWO_MINS
...
fun ReminderDialogContent(
    ...
    val reminders = listOf(
        ...
        Reminder(R.string.one_min, ONE_MIN, TimeUnit.SECONDS, plantName),
        Reminder(R.string.two_mins, TWO_MINS, TimeUnit.SECONDS, plantName),
        Reminder(R.string.three_mins, THREE_MINS, TimeUnit.SECONDS, plantName)
    )
